...
export declare class MdbCarouselComponent implements AfterViewInit, OnDestroy {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<MdbCarouselComponent, "mdb-carousel", never, { "animation": "animation"; "controls": "controls"; "dark": "dark"; "indicators": "indicators"; "ride": "ride"; "interval": "interval"; "keyboard": "keyboard"; "pause": "pause"; "wrap": "wrap"; }, { "slide": "slide"; "slideChange": "slideChange"; }, ["_items"], ["*"]>;
}
