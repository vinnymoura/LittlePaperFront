...
export declare class MdbRangeComponent implements ControlValueAccessor, AfterViewInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<MdbRangeComponent, "mdb-range", never, { "id": "id"; "required": "required"; "name": "name"; "value": "value"; "disabled": "disabled"; "label": "label"; "min": "min"; "max": "max"; "step": "step"; "default": "default"; "defaultRangeCounterClass": "defaultRangeCounterClass"; }, { "rangeValueChange": "rangeValueChange"; }, never, never>;
}
